...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //spinner
        val spinnerItem = resources.getStringArray(R.array.spinner_items)
        val spinAdapter =
            ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, spinnerItem)
        binding.topSpinner.adapter = spinAdapter


        //아이템 클릭 시 디테일 화면으로 이동
        ...
        binding.recyclerView.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrollStateChanged(recyclerView: RecyclerView, newState: Int) {
                ...
                if (!binding.recyclerView.canScrollVertically(-1)
                    ...
                    binding.upArrow.startAnimation(fadeOut)
                    binding.upArrow.visibility = View.INVISIBLE
                    isTop = true
                } else {
                    if (isTop) {
                        binding.upArrow.visibility = View.VISIBLE
                        binding.upArrow.startAnimation(fadeIn)
                        isTop = false
                    }
                }
            }
    ...
    override fun onBackPressed() {
        ...
        val alertDialog = AlertDialog.Builder(this)
            .setIcon(R.drawable.image_comment)
            .setTitle("종료")
